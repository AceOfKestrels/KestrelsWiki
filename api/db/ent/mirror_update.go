...
// SetNillableTargetPath sets the "targetPath" field if the given value is not nil.
func (mu *MirrorUpdate) SetNillableTargetPath(s *string) *MirrorUpdate {
	if s != nil {
		mu.SetTargetPath(*s)
	}
	return mu
...
// SetTargetPath sets the "targetPath" field.
func (muo *MirrorUpdateOne) SetTargetPath(s string) *MirrorUpdateOne {
	muo.mutation.SetTargetPath(s)
	return muo
}

// SetNillableTargetPath sets the "targetPath" field if the given value is not nil.
func (muo *MirrorUpdateOne) SetNillableTargetPath(s *string) *MirrorUpdateOne {
	if s != nil {
		muo.SetTargetPath(*s)
	}
	return muo
